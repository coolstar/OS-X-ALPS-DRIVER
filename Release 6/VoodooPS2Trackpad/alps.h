...
class AppleUSBMultitouchDriver;
...
typedef bool (AppleUSBMultitouchDriver::*hw_init)();
typedef bool (AppleUSBMultitouchDriver::*decode_fields)(struct alps_fields *f, UInt8 *p);
typedef void (AppleUSBMultitouchDriver::*process_packet)(UInt8 *packet);
//typedef void (AppleUSBMultitouchDriver::*set_abs_params)();
...
class EXPORT AppleUSBMultitouchDriver : public VoodooPS2TouchPadBase {
...
public:
    virtual AppleUSBMultitouchDriver * probe(IOService *provider, SInt32 *score);
...
protected:
    ...
    int processBitmap(struct alps_data *priv, struct alps_fields *f);
